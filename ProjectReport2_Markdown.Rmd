...
k12_segments_2h <- 					#Adding TierName
  st_join(k12_segments_2h, wildschwein_BE_win_k12, by = "segment_ID") 
...
all_segments <- k12_segments_2h %>%
  ...
  filter(DatetimeUTC >=as.Date("2015-01-01")& DatetimeUTC <=as.Date("2015-05-01"))

ggplot(data =all_segments, mapping = aes(x= E, y=N) )+
