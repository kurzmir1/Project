...
k12_segments <-
  left_join(k12_segments, habitat, by = "segment_ID")

ggplot(k12_segments_2h, mapping = aes(segment_habitat))+
  geom_histogram(bins = 200)
```
...
It could also be interesting to see if the hypothesis that resting behavior is mostly after foraging.
