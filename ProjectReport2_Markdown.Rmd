...
Because the time intervals of the measurements of animals were different and for some animals there were gabs between two observed fix points, our resultants may have some deviations from an actual behavior. 
It could also be interesting to see if the hypothesis that resting behavior is mostly after foraging is true.
